  ...
  return (
    <div className={'min-w-[800px]'}>
      ...
      <div className={'h-[200px] ml-[10%] mr-[30%] mt-[60px]'} ref={objSection}>
        ...
        {/*<h1>Self Intro</h1>*/}
        <span className={''}>
          I’m Liam, a full stack developer. For the past 3 years, I have been
          working on Developer with a diverse background in finance and retail,
          eager to pursue a more front-end focusing role.
          <br />
        </span>
      </div>
